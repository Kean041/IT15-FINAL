...
namespace FinSight.Migrations
{
    ...
    [Migration("20260804061003_AddScenarioEconomicAssumptions")]
    partial class AddScenarioEconomicAssumptions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinSight.Models.Scenario", b =>
                {
                    ...
                    b.Property<decimal?>("AppliedInflation")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("FinSight.Models.Expense", b =>
                {
                    ...
                    b.HasOne("FinSight.Models.BudgetRequest", "BudgetRequest")
                        .WithMany()
